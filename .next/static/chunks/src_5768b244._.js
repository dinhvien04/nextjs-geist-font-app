...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const { data, error: apiError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].register(formData.username, formData.email, formData.password);
            if (apiError) {
...
_s(RegisterPage, "/Q6XJq9zVZLyNNPsTTFpq8vTCyA=", false, function() {
    return [
...
//# sourceMappingURL=src_5768b244._.js.map