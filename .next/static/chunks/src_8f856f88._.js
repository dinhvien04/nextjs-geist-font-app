...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const { data, error: apiError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].login(email, password);
            if (apiError) {
...
//# sourceMappingURL=src_8f856f88._.js.map